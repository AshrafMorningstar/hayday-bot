---
trigger: always_on
description: Enforce structured project logging across all sessions. The agent MUST create and maintain the project-logs/ folder and its four files at ALL times.
---
